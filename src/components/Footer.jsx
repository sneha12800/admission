    ...
    <footer className="bg-[#1A1817] text-[#EFE7DF]/80 pt-24 pb-12 relative overflow-hidden font-sans border-t-4 border-[#E5AA3E]">
      ...
      <div className="absolute right-0 bottom-0 w-full h-full overflow-hidden pointer-events-none opacity-[0.03] flex items-end justify-end">
        <img
          src={logo}
          alt=""
          className="w-[400px] h-[400px] object-contain transform translate-y-16 translate-x-16"
        />
      </div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 xl:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 bg-white/[0.03] border border-white/10 rounded-2xl p-8 md:p-16 mb-24 relative overflow-hidden group">
          ...
          <div className="lg:col-span-7">
            <h3 className="font-serif text-3xl md:text-4xl font-black text-white mb-6 leading-tight">
              Stay informed, <br />
              stay <span className="text-[#E5AA3E]">ahead.</span>
            </h3>
            <p className="text-gray-400 text-lg max-w-xl leading-relaxed">
              Subscribe to the official Trident Newsletter for updates on
              research, events, and campus developments.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 mb-24">
          ...
          <div className="lg:col-span-4">
            <a
              href="/"
              className="flex items-center gap-5 mb-10 no-underline"
            >
              <img
                src={logo}
                alt="TAT Logo"
              ...
              <div className="flex flex-col justify-center">
                <div className="font-serif text-[28px] text-white leading-none font-black uppercase">
                  Trident
                </div>
                <div className="text-[10px] font-bold text-[#8B6E66] tracking-[.3em] uppercase mt-2">
            ...
            <p className="text-gray-400 text-[16px] leading-[1.8] mb-10">
              ...
              world-class technical education, innovative research, and an
              unwavering commitment to excellence.
            </p>

            <div className="grid grid-cols-1 gap-6">
              <a
                href="https://contactus-tat.tekkzy.com"
                className="flex items-start gap-4 hover:text-white transition-colors group no-underline"
              >
                <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-[#8B6E66] flex-shrink-0">
                  <MapPin size={20} />
                </div>
                <div className="text-sm font-medium leading-relaxed">
                  F2/A, Chandaka Industrial Estate,
                  <br />
                  In front of Infocity, Bhubaneswar,
                  <br />
                  Odisha, Pin: 751024, India
                </div>
              </a>
              <a
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-[#8B6E66]">
                  <Phone size={20} />
                </div>
            ...
            {[
              {
                ...
                ls: [
                  {
                    t: "Undergraduate Studies",
                    h: "https://academics-tat.tekkzy.com/departments-of-engineering/",
                  },
                  {
                    t: "Postgraduate Studies",
                    h: "https://academics-tat.tekkzy.com/",
                  },
                  {
                    t: "Doctoral Programs",
                    h: "https://academics-tat.tekkzy.com/",
                  ...
                  {
                    t: "Research Centers",
                    h: "https://research-tat.tekkzy.com/",
                  },
                  {
                    t: "Academic Calendar",
                    h: "https://academics-tat.tekkzy.com/calendars/",
                  },
                ],
              },
              {
                ...
                ls: [
                  {
                    t: "Student Hostels",
                    h: "https://campuslife-tat.tekkzy.com/",
                  },
                  {
                    t: "Clubs & Societies",
                    h: "https://sipitridentactivity.netlify.app/",
                  },
                  {
                    t: "Sports & Recreation",
                    h: "https://campuslife-tat.tekkzy.com/",
              ...
              },
              {
                ...
                ls: [
                  {
                    t: "Admissions Portal",
                    h: "https://admissions-tat.tekkzy.com",
                  },
                  {
                    t: "Alumni Network",
                    h: "https://alumni-tat.tekkzy.com/",
                  },
                  {
                    t: "Career Placements",
                    h: "https://placements-tat.tekkzy.com",
                  },
                  {
                    t: "NIRF Data",
                    h: "https://academics-tat.tekkzy.com/",
              ...
              <div key={col.h}>
                <div className="relative mb-10">
                  ...
                  <h5 className="font-serif text-white font-black text-[15px] uppercase tracking-widest relative z-10">
                    {col.h}
                  </h5>
                </div>
                <ul className="space-y-5">
                  {col.ls.map((link) => (
                    <li key={link.t}>
                      <a
                        href={link.h}
                        className="text-[14px] font-bold text-gray-500 hover:text-[#E5AA3E] transition-all flex items-center gap-3 group"
                      >
            ...
            <div className="flex gap-4 text-[11px] font-bold text-gray-600">
              {["Privacy Policy", "Disclaimer", "Terms of Use"].map((l) => (
                <a
                  ...
                  className="hover:text-[#E5AA3E] transition-colors uppercase tracking-wider"
                >
                  {l}
                </a>
              ))}
          ...
          <div className="flex items-center gap-5">
            {[Facebook, Twitter, Linkedin, Instagram].map((Icon, i) => (
              <a
                key={i}
                href="https://tat.tekkzy.com/"
                className="text-gray-500 hover:text-[#E5AA3E] transition-colors"
              >
                <Icon size={20} />
              </a>
            ))}
        ...
        <div className="text-center mt-8 pt-6 border-t border-white/5">
          <span className="text-[11px] font-medium text-gray-600 tracking-wider">
            ...
            <a
              ...
              className="text-gray-400 hover:text-[#E5AA3E] transition-colors font-bold"
            >
              Tekkzy
            </a>{" "}
